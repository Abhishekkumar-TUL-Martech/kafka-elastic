...
public class ElasticServiceImpl implements ElasticService{
    ...
    public List<Customer> findCustomerById(String id) {
        ...
        QueryBuilder queryBuilder = QueryBuilders.matchQuery("customer_id", id);
        NativeSearchQuery searchQuery = new NativeSearchQueryBuilder().withQuery(queryBuilder).build();
        SearchHits<Customer> customerHits = elasticsearchOperations.search(searchQuery, Customer.class, IndexCoordinates.of("kibana_sample_data_ecommerce"));
